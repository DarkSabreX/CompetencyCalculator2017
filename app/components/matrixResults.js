            ...
            <md-card class="tblcard">
                    ...
                    <md-card-content>
                        <div style="text-align: center;" style="margin-bottom: 2%;">
                            ...
                            <h2 ng-attr-style="{{cmatrix.comptotaltxtcolor}}">{{$ctrl.finalScore}}</h2> or <h2 ng-attr-style="{{cmatrix.comptotaltxtcolor}}">{{cmatrix.comptotaltxt}}</h2>
                        ...
                        <div class="md-whiteframe-4dp" style="padding: 2%;">
                            <span class="layout-max-width" ng-repeat="object in $ctrl.finalDescriptions"><b>{{object.competency}}</b>: {{object.description}}</span>
                        </div>
                    </md-card-content>
                </md-card>
            </md-content>
